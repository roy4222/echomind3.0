  ...
  return (
    <div className="w-full bg-white dark:bg-gray-700 p-4 rounded-lg shadow-md mb-4 border border-gray-100 dark:border-gray-600">
      ...
      <div className="flex gap-2">
        <button
          className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-all duration-200 ${difficulty === 'easy'
        ...
        <button
          className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-all duration-200 ${difficulty === 'medium'
        ...
        <button
          className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-all duration-200 ${difficulty === 'hard'
