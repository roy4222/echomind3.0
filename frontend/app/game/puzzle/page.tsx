...
export default function HomePage() {
  ...
  return (
    ...
    <div
      className={`w-full bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 min-h-screen transition-all duration-700 ${
        animation ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"
      }`}
    >
      {/* 主題選擇區塊 - 中央內容區域 */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 mb-12">
        <h2 className="text-2xl font-semibold text-center pt-12 mb-6 text-gray-800 dark:text-gray-200">
          選擇主題
        </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
          ...
          {themes.map((theme) => (
            <div
              ...
              className={`p-4 border rounded-lg cursor-pointer transition-all duration-300 transform hover:scale-105 hover:shadow-lg bg-white dark:bg-gray-700 ${
                selectedTheme === theme.id
                  ? "border-gray-800 dark:border-gray-400 shadow-md bg-gray-50 dark:bg-gray-600"
            ...
            >
              ...
              {/* 主題名稱 */}
              <p className="text-center font-medium text-gray-800 dark:text-gray-200 text-lg">
                {theme.name}
              </p>
            </div>
          ))}
