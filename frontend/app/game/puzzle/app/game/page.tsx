...
export default function GamePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 py-6">
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="mb-4 flex justify-between items-center bg-white/90 dark:bg-gray-700/90 backdrop-blur-sm rounded-xl shadow-md p-3">
          <Link 
            href="/game/puzzle"
          ...
          <div className="text-xl font-bold text-gray-800 dark:text-gray-200 hidden md:block">
            拼圖挑戰  
          </div>
