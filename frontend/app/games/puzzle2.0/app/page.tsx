...
export default function HomePage() {
  ...
  // 拼圖主題資料
  const themes = [
    { id: '1', name: 're0 愛蜜莉雅', image: '/images/puzzles/1.png' },
    { id: '2', name: '間諜家家酒', image: '/images/puzzles/4.png' },
    { id: '3', name: '敗北女角太多了', image: '/images/puzzles/3.png' },
    { id: '4', name: '孤獨搖滾', image: '/images/puzzles/2.png' }
  ]
  ...
  return (
    ...
    <div className={`w-full bg-gradient-to-b from-gray-50 to-gray-100 min-h-screen transition-all duration-700 ${animation ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
      ...
      <div className="flex flex-col items-center gap-4 mb-16">
        ...
        <Link
          href={`/game?theme=${selectedTheme}&difficulty=${difficulty}`}
