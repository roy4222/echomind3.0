...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setIsLoading(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loginWithEmail"])(formData.email, formData.password);
            router.push('/');
        } catch (err) {
            const authError = err;
    ...
    const handleGoogleLogin = async ()=>{
        ...
        setIsLoading(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["loginWithGoogle"])();
            router.push('/');
        } catch (err) {
            const authError = err;
            setError(authError.message);
